...
namespace FunHomeClub.res.db {
    ...
    public partial class masterDBDataSet : global::System.Data.DataSet {
        ...
        public partial class courseDataTable : global::System.Data.TypedTableBase<courseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public courseRow AddcourseRow(string courseID, string name, int quota, string weekday, string room, System.DateTime startTime, System.DateTime endTime, int teacherRate, int operatingCharges, courseCategoryRow parentcourseCategoryRowBycourseCategorycourse, teacherRow parentteacherRowByteachercourse) {
...
namespace FunHomeClub.res.db.masterDBDataSetTableAdapters {
    ...
    public partial class courseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `course` WHERE ((`courseID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `quota` IS NULL) OR (`quota` = ?)) AND ((? = 1 AND `weekday` IS NULL) OR (`weekday` = ?)) AND ((? = 1 AND `room` IS NULL) OR (`room` = ?)) AND ((? = 1 AND `startTime` IS NULL) OR (`startTime` = ?)) AND ((? = 1 AND `endTime` IS NULL) OR (`endTime` = ?)) AND ((? = 1 AND `teacherRate` IS NULL) OR (`teacherRate` = ?)) AND ((? = 1 AND `operatingCharges` IS NULL) OR (`operatingCharges` = ?)) AND ((? = 1 AND `categoryID` IS NULL) OR (`categoryID` = ?)) AND ((? = 1 AND `teacherID` IS NULL) OR (`teacherID` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `course` (`courseID`, `name`, `quota`, `weekday`, `room`, `startTime`" +
                ", `endTime`, `teacherRate`, `operatingCharges`, `categoryID`, `teacherID`) VALUE" +
                "S (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `course` SET `courseID` = ?, `name` = ?, `quota` = ?, `weekday` = ?, `room` = ?, `startTime` = ?, `endTime` = ?, `teacherRate` = ?, `operatingCharges` = ?, `categoryID` = ?, `teacherID` = ? WHERE ((`courseID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `quota` IS NULL) OR (`quota` = ?)) AND ((? = 1 AND `weekday` IS NULL) OR (`weekday` = ?)) AND ((? = 1 AND `room` IS NULL) OR (`room` = ?)) AND ((? = 1 AND `startTime` IS NULL) OR (`startTime` = ?)) AND ((? = 1 AND `endTime` IS NULL) OR (`endTime` = ?)) AND ((? = 1 AND `teacherRate` IS NULL) OR (`teacherRate` = ?)) AND ((? = 1 AND `operatingCharges` IS NULL) OR (`operatingCharges` = ?)) AND ((? = 1 AND `categoryID` IS NULL) OR (`categoryID` = ?)) AND ((? = 1 AND `teacherID` IS NULL) OR (`teacherID` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT courseID, name, quota, weekday, room, startTime, endTime, teacherRate, ope" +
                "ratingCharges, categoryID, teacherID FROM course";
        ...
        public virtual int Delete(string Original_courseID, string Original_name, int Original_quota, string Original_weekday, string Original_room, System.DateTime Original_startTime, System.DateTime Original_endTime, int Original_teacherRate, int Original_operatingCharges, string Original_categoryID, string Original_teacherID) {
        ...
        public virtual int Insert(string courseID, string name, int quota, string weekday, string room, System.DateTime startTime, System.DateTime endTime, int teacherRate, int operatingCharges, string categoryID, string teacherID) {
            if ((courseID == null)) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[15].Value = ((int)(Original_quota));
            if ((Original_weekday == null)) {
                throw new global::System.ArgumentNullException("Original_weekday");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[16].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[17].Value = ((string)(Original_weekday));
            }
            if ((Original_room == null)) {
                throw new global::System.ArgumentNullException("Original_room");
            }
        ...
        public virtual int Update(
                    ...
                    string Original_categoryID, 
                    string Original_teacherID) {
            return this.Update(Original_courseID, name, quota, weekday, room, startTime, endTime, teacherRate, operatingCharges, categoryID, teacherID, Original_courseID, Original_name, Original_quota, Original_weekday, Original_room, Original_startTime, Original_endTime, Original_teacherRate, Original_operatingCharges, Original_categoryID, Original_teacherID);
        }
    }
